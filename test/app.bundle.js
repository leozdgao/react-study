...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cssInfoCss = __webpack_require__(161);
	...
	var App = _reactAddons2['default'].createClass({
	  ...
	  _getItems: function _getItems() {
	    return this.state.items.map(function (val, i) {
	      return _reactAddons2['default'].createElement(
	        'li',
	        { key: val },
	        val
	  ...
	  _handleAdd: function _handleAdd() {
	    ...
	    setTimeout(function () {
	      _this.setState({ items: ['test' + seed++] });
	    }, animationTime);
	  },
	...
	var Info = _reactAddons2['default'].createClass({
	  displayName: 'Info',
	  ...
	  render: function render() {
	    return _reactAddons2['default'].createElement(
	      ...
	      _reactAddons2['default'].createElement(
	        ...
	        _reactAddons2['default'].createElement(
	          'span',
	          { className: _cssInfoCss2['default'].name },
	          'AA'
	        ),
	        'Info'
	      ),
	      ...
	      _reactAddons2['default'].createElement(
	        'ul',
	        null,
	        _reactAddons2['default'].createElement(_uploader2['default'], null)
	      ),
	      _reactAddons2['default'].createElement(
	        _reactRouter.Link,
	        { to: "about" },
	...
	var About = _reactAddons2['default'].createClass({
	  displayName: 'About',
	...
	var routes = _reactAddons2['default'].createElement(
	  _reactRouter.Route,
	  { handler: App },
	  _reactAddons2['default'].createElement(_reactRouter.Route, { name: "info", path: "", handler: Info }),
	  _reactAddons2['default'].createElement(_reactRouter.Route, { name: "about", path: "about", handler: About })
	);

	_reactRouter2['default'].run(routes, _reactRouter2['default'].HistoryLocation, function (Root) {
	  _reactAddons2['default'].render(_reactAddons2['default'].createElement(Root, null), document.getElementById('test-container'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _badge = __webpack_require__(160);
